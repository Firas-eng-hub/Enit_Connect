...
export function NotificationsPage() {
  ...
  const fetchNotifications = async () => {
    ...
    setError(null);
    try {
      const response = await httpClient.get('/api/admin/notifications');
  ...
  const markAsRead = async (id: string) => {
    try {
      await httpClient.patch(`/api/admin/notifications/${id}/read`);
  ...
  const markAllAsRead = async () => {
    try {
      await httpClient.patch('/api/admin/notifications/read-all');
      await fetchNotifications();
    } catch (err) {
