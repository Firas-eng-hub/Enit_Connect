  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: 'Your application for "Full Stack Developer Intern" has been submitted successfully.',
      time: '2 hours ago',
      read: false,
    },
    {
      ...
      message: 'A new PFE offer matching your profile has been posted by TechCorp.',
      time: '5 hours ago',
      read: false,
    },
    {
